...
Version  : 4.7.0
Release  : 1
URL      : http://sourceforge.net/projects/perfmon2/files/libpfm4/libpfm-4.7.0.tar.gz
Source0  : http://sourceforge.net/projects/perfmon2/files/libpfm4/libpfm-4.7.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1536449880
make  %{?_smp_mflags}
